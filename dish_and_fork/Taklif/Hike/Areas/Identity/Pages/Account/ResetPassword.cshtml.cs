...
namespace Hike.Areas.Identity.Pages.Account
{
    ...
    public class ResetPasswordModel : PageModel
    {
        ...
        public ResetPasswordModel(UserManager<HikeUser> userManager, IReturnUrlRepository returnUrlRepository)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string code = null, string returnUrl = null)
        {
